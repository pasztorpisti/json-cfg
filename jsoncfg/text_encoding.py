...
def load_utf_text_file(file, default_encoding='UTF-8', use_utf8_strings=True):
    """
    Loads the specified text file and tries to decode it using one of the UTF encodings.
    :param file: The path to the loadable text file or a file-like object with a read() method.
    ...
    """
    if isinstance(file, my_basestring):
