from .compatibility import python2


def load_utf_text_file(filename, default_encoding='UTF-8', use_utf8_strings=True):
    """
    Loads the specified text file and tries to decode it using one of the UTF encodings.
    :param filename: The path to the loadable text file.
